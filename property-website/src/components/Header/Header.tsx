...
const Header = () => {
    ...
    <div className="bg w-screen flex justify-center items-center gap-5 relative" style={{height:'12vh'}}>
        ...
        <nav className="flex items-center gap-24 ml-96 xl:ml-96 xl:gap-32 lg:ml-72 lg:gap-20 md:gap-10 md:ml-40">
        ...
        <Link className="absolute right-20" to='/wishList' style={{fontFamily:'Montserrat'}}><FavoriteBorderIcon /></Link>
